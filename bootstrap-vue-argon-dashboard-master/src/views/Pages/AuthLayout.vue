     ...
     <template>
       <div class="navbar-collapse-header">
         ...
         <b-navbar-nav  class="align-items-lg-center ml-lg-auto">
           <b-nav-item to="/registerGuardians">
               <i class="ni ni-planet"></i>
               <span class="nav-link-inner--text">Register Guardian</span>
           </b-nav-item>
           <b-nav-item to="/login">
               <i class="ni ni-key-25"></i>
               <span class="nav-link-inner--text">Login</span>
           </b-nav-item>
           <b-nav-item to="/ClassSearch">
               <i class="ni ni-key-25"></i>
               <span class="nav-link-inner--text">Class Search</span>
           </b-nav-item>
       </b-navbar-nav>
     </template>
    </base-nav>
