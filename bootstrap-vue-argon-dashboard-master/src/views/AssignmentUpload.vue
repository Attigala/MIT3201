  ...
  <div>
    ...
    <b-container fluid class="mt--7">
      ...
      <b-card-header class="bg-transparent border-0">
            <h3 class="mb-0 text-white">Upload Assignment</h3>
            <input type=text placeholder="Due Date YYYY-MM-DD" v-model="dueDate"> <br/> <br/>
...
export default {
  ...
  methods: {
    saveFile () {
      ...
      console.log(dueDate)
      ClassContractDataService.saveAssignment(localStorage.getItem("classId"), dueDate, formData, headers).then(response => {
